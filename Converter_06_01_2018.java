...
public class Converter  {
    ...
    public final Color [] c7= new Color [1792];
    public final Color [] cf= new Color [895];
    public final Color [] c5= new Color [1024];
    public final Color [] c2= new Color [256];
    public final Color [] c2m= new Color [256];    
    ...
    public void Temp_Converter_Image( Double MAX, Double MIN,Double HIGHTEMP,int TOL, Color [] cplt, Color [][] cimg,File infile,File outfile) throws IOException {
        ...
        printimage(infile,outfile,cimg);
        Wound_Count();
    }
