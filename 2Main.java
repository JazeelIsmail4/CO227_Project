...
public class Main {
    ...
    public static void main(String[] args) throws IOException  {
        ...
        //System.out.print(Infiles[0]+"\n");
        //System.out.print(Infilepath.getPath()+"\t"+Infiles[0].getName()+"\n");
...
//        //Rain();                     //run the function for 7colour heat map rgb creation
        ...
        for (File Afile:Infiles) {
            ...
            if (FileName.endsWith(".jpg") == true ||FileName.endsWith(".png") == true || FileName.endsWith(".jpeg") == true ) {
                
                String OutImageName =FileName.replace(".jpg", "_Output.png");
                //String OutFileName=Nm+"_Output.png";
                String OutputFilePath = Infilepath+"\\Results\\"+OutImageName;
